package com.migtation.server.controllers.client.v1;

import com.migtation.server.dtos.request.user.RequestCreateUser;
import com.migtation.server.dtos.request.user.RequestUpdateUser;
...
public class UserControllerClient {
    ...
    @Autowired
    public UserControllerClient(final UserService userService) {
